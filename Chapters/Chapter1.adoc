...
Компилятор indexterm:["компилятор"] -- система, преобразующая язык программы с одного на другой.
...
=== Инструментарий компилятора indexterm:["инструментарий компилятора"]
...
=== Процесс компиляции indexterm:["компиляция"]
...
Итак, инструментарий компилятора indexterm:["инструментарий компилятора"] -- это набор инструментов, вспомогательных библиотек и заголовочных файлов, которые помогают собрать программу из исходного кода в исполняемый файл, который может выполняться на компьютере. 
...
=== Инструментарий indexterm:["инструментарий компилятора"]
...
=== Кросс-компиляция indexterm:["кросс-компиляция"]
...
=== Введение в инструментарий GCC indexterm:["инструментарий компилятора","GCC"]
...
=== Введение в инструментарий LLVM indexterm:["инструментарий компилятора","LLVM"]
